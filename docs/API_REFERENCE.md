...
Automatically extracted API documentation generated directly from JSDoc/TSDoc metadata across **146 TypeScript modules** in DeepSift.
...
## 📄 [`diagnose-search`](file:///packages/deepsift-core/src/benchmark/diagnose-search.ts)

- **Path:** `packages/deepsift-core/src/benchmark/diagnose-search.ts`  
