...
deepsift config
```
این دستور منوی تعاملی کنسول را باز می‌کند که در آن می‌توانید فولدرهای مدنظر را تیک بزنید یا تیک آنها را بردارید تا در فایل `deepsift.config.json` ذخیره شوند.
